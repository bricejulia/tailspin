...
func TestParseCommand(t *testing.T) {
	cases := []struct {
		...
		{input: "  tail  ", want: parsedCommand{Kind: cmdTail}},
		{input: "query", want: parsedCommand{Kind: cmdQuery}},
		{input: "raw", want: parsedCommand{Kind: cmdQuery}},
		{input: "save my-query", want: parsedCommand{Kind: cmdSave, Arg: "my-query"}},
		{input: "SAVE my-query", want: parsedCommand{Kind: cmdSave, Arg: "my-query"}},
		{input: "save", wantErr: true},
		{input: "load my-query", want: parsedCommand{Kind: cmdLoad, Arg: "my-query"}},
		{input: "load", wantErr: true},
		{input: "queries", want: parsedCommand{Kind: cmdQueries}},
		{input: "", wantErr: true},
		{input: "   ", wantErr: true},
