...
func helpText() string {
	lines := []string{
		...
		footerKeyStyle.Render("g") + "          toggle the histogram (hidden by default — each fetch costs paced",
		"           Cloud Logging read requests); click/drag its bars to set the time range to what you selected",
